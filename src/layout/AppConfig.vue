...
const onChangeTheme = (theme, mode) => {
    ...
    // console.log("linkElement.getAttribute('href'): ", linkElement.getAttribute('href'));
    // console.log('layoutConfig.theme.value: ', layoutConfig.theme.value);
    // console.log('theme: ', theme);
    // console.log("linkElement.getAttribute('href').replace(theme, layoutConfig.theme.value): ", linkElement.getAttribute('href').replace(layoutConfig.theme.value, theme));

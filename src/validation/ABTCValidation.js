...
export default function createValidationRules() {
    ...
    const validationRules = {
        ...
        followUp: {
            complaints: { requiredIf: patientStore.progressionDay !== '0' },
            adverse_reaction: { requiredIf: patientStore.progressionDay !== '0' },
            biting: { requiredIf: patientStore.type_prophylaxis === 'POST-EXPOSURE' && patientStore.progressionDay !== '0' },
            finding: { requiredIf: patientStore.type_prophylaxis === 'PRE-EXPOSURE' && patientStore.progressionDay !== '0' },
            finding_sp: { requiredIf: patientStore.details.followUp.finding === 'WITH FINDINGS' && patientStore.progressionDay !== '0' },
            // others: { requiredIf: patientStore.progressionDay !== '0' },
            wound_description: { requiredIf: patientStore.type_prophylaxis === 'POST-EXPOSURE' && patientStore.progressionDay !== '0' },
            erythema: { requiredIf: patientStore.type_prophylaxis === 'POST-EXPOSURE' && patientStore.progressionDay !== '0' },
            discharge: { requiredIf: patientStore.type_prophylaxis === 'POST-EXPOSURE' && patientStore.progressionDay !== '0' },
            tenderness: { requiredIf: patientStore.type_prophylaxis === 'POST-EXPOSURE' && patientStore.progressionDay !== '0' },
            hematoma: { requiredIf: patientStore.type_prophylaxis === 'POST-EXPOSURE' && patientStore.progressionDay !== '0' }
        },
        ABTC: {
            erig: {
                requiredIf:

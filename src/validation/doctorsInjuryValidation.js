...
export default function createValidationRules() {
    ...
    const validationRules = {
        ...
        ExternalCauseOfInjury: {
            ...
            washingDone_by: {
                requiredIf: patientStore.details.ExternalCauseOfInjury.ext_bite === 'Y' && patientStore.details.ExternalCauseOfInjury.washingDone === 'Y'
            },
            previousARV: {
                requiredIf: patientStore.details.ExternalCauseOfInjury.ext_bite === 'Y'
            },
            ...
            pvrv_site_2: {
                requiredIf: patientStore.details.ExternalCauseOfInjury.ext_bite === 'Y' && patientStore.details.ExternalCauseOfInjury.pvrv === 'Y' && patientStore.details.ExternalCauseOfInjury.pvrv_site_4 !== 'Y'
            },
            pvrv_site_4: {
                requiredIf: patientStore.details.ExternalCauseOfInjury.ext_bite === 'Y' && patientStore.details.ExternalCauseOfInjury.pvrv === 'Y' && patientStore.details.ExternalCauseOfInjury.pvrv_site_2 !== 'Y'
            },
            pcec_site_2: {
                requiredIf: patientStore.details.ExternalCauseOfInjury.ext_bite === 'Y' && patientStore.details.ExternalCauseOfInjury.pcec === 'Y' && patientStore.details.ExternalCauseOfInjury.pcec_site_4 !== 'Y'
            },
            pcec_site_4: {
                requiredIf: patientStore.details.ExternalCauseOfInjury.ext_bite === 'Y' && patientStore.details.ExternalCauseOfInjury.pcec === 'Y' && patientStore.details.ExternalCauseOfInjury.pcec_site_2 !== 'Y'
            },
            hrig_num: {
                requiredIf: patientStore.details.ExternalCauseOfInjury.ext_bite === 'Y' && patientStore.details.ExternalCauseOfInjury.hrig === 'Y'
            },
            erig_num: {
                requiredIf: patientStore.details.ExternalCauseOfInjury.ext_bite === 'Y' && patientStore.details.ExternalCauseOfInjury.erig === 'Y'
            },

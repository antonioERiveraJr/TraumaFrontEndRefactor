            ...
            <div v-else>
                <div v-if="isUpdateForm">
                    <Button
                        label="Update"
                        icon="pi pi-save"
                        class="w-auto border border-gray-400 rounded-lg bg-blue-400 text-white font-semibold hover:bg-green-400 transition duration-200 ease-in-out shadow-lg"
                ...
                <div v-else>
                    <Button
                        label="Save"
                        icon="pi pi-save"
                        class="w-auto border border-gray-300 rounded-lg bg-blue-400 text-white font-semibold hover:bg-green-400 transition duration-200 ease-in-out shadow-lg"

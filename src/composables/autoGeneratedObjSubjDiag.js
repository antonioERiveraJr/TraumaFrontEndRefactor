                ...
                if (patientStore.progressionDay !== '' || undefined || null) {
                    ...
                    if (patientStore.type_prophylaxis === 'PRE-EXPOSURE') {
                        ...
                        if (progressionDay === '28') {
                            ...
                            if (patientStore.details.ABTC.immunization_schedule === 'BOOSTER') {
                                if (patientStore.details.ABTC.booster_regimen) {
                                ...
                                plan = `PEP Day-${patientStore.progressionDay} `;
                                if (patientStore.details.ABTC.vaccine_none_sp === 'NO ARV NEEDED') {
                                    plan += `NO VACCINE AT THE TIME OF CONSULTATION. STILL COVERED BY PREVIOUS VACCINE.\n`;
                                } else if (patientStore.details.ABTC.vaccine_none_sp === 'STILL COVERED' && patientStore.details.ABTC.coveredDate) {
                                    plan += `TOO EARLY FOR DOSE, TO COME BACK ON ${patientStore.details.ABTC.coveredDate} FOR DAY-${patientStore.progressionDay}. NO VACCINE FOR TODAY\n`;
                                }
                                if (pvrv === 'Y') {
                                    if (pvrv_site_1_im === 'Y') {

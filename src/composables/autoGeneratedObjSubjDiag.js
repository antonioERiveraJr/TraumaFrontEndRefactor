                    ...
                    if (patientStore.type_prophylaxis === 'PRE-EXPOSURE') {
                        ...
                        if (progressionDay === '28') {
                            ...
                            if (patientStore.details.ABTC.immunization_schedule === 'BOOSTER') {
                                ...
                                if (patientStore.details.ABTC.erig_num !== '' && patientStore.details.ABTC.erig === 'Y') {
                            ...
                            if (patientStore.details.ABTC.medication !== '' && patientStore.patientTSSRecord?.data?.[0]) {
                                plan += `Continue ${patientStore.details.ABTC.medication}.\n`;
                            } else if (patientStore.details.ABTC.medication !== '' && !patientStore.patientTSSRecord?.data?.[0]) {
